...
public class Parameters {
    ...
    public static const FULL_BUILD_VERSION:String = "Testing.Testing.Testing"; //BUILD_VERSION + "." + MINOR_VERSION + "." + PATCH_VERSION;
    public static const PORT:int = 2050;
    public static const LOCAL_HOST:Boolean = falseye
    wh;
