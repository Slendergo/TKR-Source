...
namespace Json
{
        ...
        static class SimpleJson
    {
        ...
        {
            get => _currentJsonSerializerStrategy ?? (_currentJsonSerializerStrategy =
 ...
 DataContractJsonSerializerStrategy
        ...
        class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        internal virtual ReflectionUtils.ConstructorDelegate ContructorDelegateFactory(Type key) => ReflectionUtils.GetContructor(key, key.IsArray ? ArrayConstructorParameterTypes : EmptyTypes);
        ...
        public virtual bool TrySerializeNonPrimitiveObject(object input, out object output) => TrySerializeKnownTypes(input, out output) || TrySerializeUnknownTypes(input, out output);
 ...
 class DataContractJsonSerializerStrategy : PocoJsonSerializerStrategy
    ...
    namespace Reflection
    {
            ...
            class ReflectionUtils
        {
            ...
            public static object ToNullableType(object obj, Type nullableType) => obj == null
                    ? null
