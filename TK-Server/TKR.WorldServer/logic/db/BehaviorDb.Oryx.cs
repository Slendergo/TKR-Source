        ...
        .Init("The Talisman King",
            new State(
                ...
                new State("Fight",
                    ...
                    new Shoot(25, projectileIndex: 3, count: 2, shootAngle: 10, predictive: 0.4, coolDown: 1000, seeInvis: true),
                    new Shoot(25, projectileIndex: 4, count: 3, shootAngle: 10, predictive: 0.6, coolDown: 1000, seeInvis: true),
                    new Shoot(25, projectileIndex: 5, count: 2, shootAngle: 10, predictive: 0.8, coolDown: 1000, seeInvis: true),
                    new Shoot(25, projectileIndex: 6, count: 3, shootAngle: 10, predictive: 1, coolDown: 1000, seeInvis: true),
                    new HpLessTransition(.66, "Attack")
                    ),
                new State("Attack",
                    new Follow(1, 15, 3),
                    new Shoot(25, projectileIndex: 0, count: 8, shootAngle: 45, coolDown: 1500, seeInvis: true),
                    ...
                    new HpLessTransition(.33, "prepareRage")
                    ),
                ...
                new State("rage",
                    ...
                    new Shoot(25, projectileIndex: 3, count: 2, shootAngle: 10, predictive: 0.4, coolDown: 700),
                    new Shoot(25, projectileIndex: 4, count: 3, shootAngle: 10, predictive: 0.6, coolDown: 700),
                    new Shoot(25, projectileIndex: 5, count: 2, shootAngle: 10, predictive: 0.8, coolDown: 700),
                    new Shoot(25, projectileIndex: 6, count: 3, shootAngle: 10, predictive: 1, coolDown: 700),
                    new TossObject("Monstrosity Scarab", 7, 0, coolDown: 1000),
                    new Taunt(1, 6000, "Puny mortals! My {HP} HP will annihilate you!")
                    )
                ),
            new Threshold(0.03,
                new ItemLoot("The Horn Breaker", 0.00033, 0, 0.05),
                new ItemLoot("Talisman Fragment", 0.01, 0, 0.05),
                new ItemLoot("Oryx's Broken Helm", 0.00033, 0, 0.05),
