...
namespace wServer.logic.behaviors
{
    internal class RemoveConditionalEffect : Behavior
    {
        ...
        protected override void OnStateEntry(Entity host, TickTime time, ref object state) => host.ApplyConditionEffect(new ConditionEffect() { Effect = _effect, DurationMS = 0 });
