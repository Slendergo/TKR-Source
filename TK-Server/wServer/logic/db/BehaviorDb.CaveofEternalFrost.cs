    ...
    partial class BehaviorDb
    {
        ...
        .Init("Abominable Snowman",
            new State(
                ...
                new State("attack",
                    new Wander(0.4),
                    new Shoot(25, projectileIndex: 0, count: 4, shootAngle: 15, predictive: 0.2, coolDown: 1500, coolDownOffset: 500),
                    new Shoot(25, projectileIndex: 0, count: 4, shootAngle: 74, coolDown: 1500, coolDownOffset: 1000),
                    new Shoot(25, projectileIndex: 2, count: 1, shootAngle: 10, predictive: 1, coolDown: 1000, coolDownOffset: 1500),
                ...
                new State("attack2",
                        ...
                        new Shoot(25, projectileIndex: 0, count: 4, shootAngle: 15, predictive: 0.2, coolDown: 1500, coolDownOffset: 500),
                        new Shoot(25, projectileIndex: 0, count: 4, shootAngle: 74, coolDown: 1500, coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 2, count: 1, shootAngle: 10, predictive: 0.4, coolDown: 4000, coolDownOffset: 1500),
                        new Shoot(25, projectileIndex: 1, count: 1, coolDown: 5000, coolDownOffset: 500),
                        new Grenade(5, 150, 10, 0, coolDown: 3500, color: 0x00ffff),
                        new Grenade(5, 150, 10, 90, coolDown: 3500, color: 0x00ffff),
                        new Grenade(5, 150, 10, 180, coolDown: 3500, color: 0x00ffff),
                ...
                new State("attack3",
                    new Chase(4, 12, duration: 8, coolDown: 2000),
                    new TossObject("Guardian's Frigid Squire", 5, angle: 120, coolDown: 999999),
                    new TossObject("Guardian's Frigid Squire", 5, angle: 360, coolDown: 999999),
                    new Shoot(25, projectileIndex: 0, count: 4, shootAngle: 15, predictive: 0.2, coolDown: 1500, coolDownOffset: 500),
                    new Shoot(25, projectileIndex: 0, count: 4, shootAngle: 74, coolDown: 1500, coolDownOffset: 1000),
                    new Shoot(25, projectileIndex: 2, count: 1, shootAngle: 10, coolDown: 2000, coolDownOffset: 1500),
                    new Shoot(25, projectileIndex: 1, count: 1, coolDown: 4500, coolDownOffset: 500),
                    new Grenade(5, 150, 10, 0, coolDown: 3500, color: 0x00ffff),
                    new Grenade(5, 150, 10, 90, coolDown: 3500, color: 0x00ffff),
                    new Grenade(5, 150, 10, 180, coolDown: 3500, color: 0x00ffff),
                    new Grenade(5, 150, 10, 270, coolDown: 3500, color: 0x00ffff),
