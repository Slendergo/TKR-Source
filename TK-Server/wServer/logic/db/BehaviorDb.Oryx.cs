        ...
        .Init("The Talisman King",
            new State(
                ...
                new State("Fight",
                    ...
                    new Shoot(25, projectileIndex: 1, count: 3, shootAngle: 10, coolDown: 1000),
            ...
            new Threshold(0.03,
                new ItemLoot("The Horn Breaker", 0.001, 0, 0.05),
                new ItemLoot("Talisman Fragment", 0.01, 0, 0.05),
                new ItemLoot("Oryx's Broken Helm", 0.001, 0, 0.05),
                new ItemLoot("Oryx's Armor of War", 0.001, 0, 0.05),
                new ItemLoot("Shattered Horn of Oryx", 0.001, 0, 0.05)
                ),
            new Threshold(0.02, 
