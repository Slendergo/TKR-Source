...
namespace wServer.networking.handlers
{
    internal class SmallSkillHandler : PacketHandlerBase<SmallSkillTree>
    {
        ...
        protected override void HandlePacket(Client client, SmallSkillTree packet, ref TickTime time) => Handle(client, packet);
        ...
        private void Handle(Client client, SmallSkillTree packet)
        {
            ...
            if (packet.skillNumber == 13)
            {
                ...
                player.Node1TickMin += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            ...
            if (packet.skillNumber == 14)
            {
                ...
                player.Node1TickMaj += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
                player.Stats.ReCalculateValues();
                player.Stats.Base.ReCalculateValues();
                player.Stats.Boost.ReCalculateValues();
            ...
            if (packet.skillNumber == 15)
            {
                ...
                player.Node1Med += !packet.removePoint ? 1 : - 1;
                player.Points -= !packet.removePoint ? 5 : - 5;
                player.Stats.ReCalculateValues();
                player.Stats.Base.ReCalculateValues();
                player.Stats.Boost.ReCalculateValues();
            }
            
            if (packet.skillNumber == 16)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node1Big += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 10 : -10;
                player.Stats.ReCalculateValues();
                player.Stats.Base.ReCalculateValues();
                player.Stats.Boost.ReCalculateValues();
            }
            
            if (packet.skillNumber == 17)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node2TickMin += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
                player.Stats.ReCalculateValues();
                player.Stats.Base.ReCalculateValues();
                player.Stats.Boost.ReCalculateValues();
            ...
            if (packet.skillNumber == 18)
            {
                ...
                player.Node2TickMaj += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            }
            
            if (packet.skillNumber == 19)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node2Med += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 5 : -5;
            }
            ...
            if (packet.skillNumber == 20)
            {
                ...
                player.Node2Big += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 10 : -10;
            }
            
            if (packet.skillNumber == 21)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node3TickMin += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            }
            
            if (packet.skillNumber == 22)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node3TickMaj += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            }
            
            if (packet.skillNumber == 23)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node3Med += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 5 : -5;
            }
            
            if (packet.skillNumber == 24)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node3Big += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 10 : -10;
            }
            
            if (packet.skillNumber == 25)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node4TickMin += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            }
            
            if (packet.skillNumber == 26)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node4TickMaj += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            }
            
            if (packet.skillNumber == 27)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node4Med += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 5 : -5;
            }
            
            if (packet.skillNumber == 28)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node4Big += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 10 : -10;
            }
            
            if (packet.skillNumber == 29)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node5TickMin += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            }
            
            if (packet.skillNumber == 30)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node5TickMaj += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 1 : -1;
            }
            
            if (packet.skillNumber == 31)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node5Med += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 5 : -5;
            }
            
            if (packet.skillNumber == 32)
            {
                if (player.Points <= 0)
                {
                    player.Points = 0;
                ...
                player.Node5Big += !packet.removePoint ? 1 : -1;
                player.Points -= !packet.removePoint ? 10 : -10;
            }
